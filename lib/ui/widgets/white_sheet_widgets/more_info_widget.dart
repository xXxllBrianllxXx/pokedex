      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TitleAndSubtitleWidget(
                title: 'Peso', subtitle: weight.toString()),
            // types names list
            PokemonInfoListWidget(listTitle: 'Tipos', pokemonData: types),
            // moves names list
            // PokemonInfoListWidget(listTitle: 'Moves', pokemonData: moves),
            // abilities names list
            PokemonInfoListWidget(listTitle: 'Habilidades', pokemonData: abilities),
          ],
        ),
      ),
    );
